# duckdb-assistant: local install
If you wish to install this python package (maybe from a branch or main) from source as a local install, run this bash program: [local_install_quick_start.sh](https://github.com/SundareshSankaran/duckdb-assistant/blob/main/build/local_install_quick_start.sh).
